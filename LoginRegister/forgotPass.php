...
<div class="container">
  ...
  icon: "<?php echo $_SESSION['status_code']; ?>",
        ...
        ?>
                ...
                <div class="input-box">
                    <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required >                    <label>Email</label>
                </div>

                <button type="submit" class="btn" value="Send OTP" name="forgot_password">Send OPT</button>
